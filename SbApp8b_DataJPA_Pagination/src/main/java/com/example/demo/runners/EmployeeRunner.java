...
public class EmployeeRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Pageable pageable=PageRequest.of(0, 5, Sort.by(Direction.ASC));
		// Pageable pageable=PageRequest.of(0, 5, Sort.by(Direction.DESC));
		// Pageable pageable=PageRequest.of(0, 5, Sort.unsorted());
		//Pageable pageable = PageRequest.of(0, 5);

		int recordSize = 5;
		long noOfPages = totalRows / recordSize;
		int eachPage = 0;
		while (eachPage <= noOfPages) 
		{
			Pageable pageable = PageRequest.of(eachPage, recordSize);
			Page<Employee> page0 = repo.findAll(pageable);

			// metadata
			System.out.println("Page details:" + page0);
	...
	private void saveBuilkRecords() {
		...
		List<Employee> list = Arrays.asList(new Employee(100, "Aaa", 100.00), new Employee(101, "Baa", 130.00),
				new Employee(102, "Caa", 260.00), new Employee(103, "Daa", 700.00), new Employee(104, "Eaa", 140.00),
				new Employee(105, "Faa", 230.00), new Employee(106, "Gaa", 340.00), new Employee(107, "Haa", 120.00),
				new Employee(108, "Iaa", 540.00), new Employee(109, "Jaa", 40.00), new Employee(110, "kaa", 600.00),
				new Employee(111, "Laa", 300.00), new Employee(112, "Maa", 700.00), new Employee(113, "Naa", 140.00),
				new Employee(114, "Oaa", 105.00), new Employee(115, "Paa", 103.00));
		repo.saveAll(list);
	}
